...
: ACS family surveys ranked by shared subtopic coverage. Intersection counts reflect question-by-subtopic overlaps, not unique questions. {#tbl-acs-family tbl-colwidths="[12,28,20,40]"}
...
![ACS family surveys: five surveys with highest shared subtopic coverage. Edge width reflects number of shared subtopic intersections. Green annotations show harmonization rates for the two evaluated pairs.](figures/fig02_acs_family.pdf){#fig-acs-family width=100%}
